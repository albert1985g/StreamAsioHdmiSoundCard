...
namespace ASIORecAndPlay
{
    internal class RecAndPlay : IDisposable
    {
        ...
        public RecAndPlay(AsioOut recordingDevice, IWavePlayer playingDevice, ChannelMapping channelMapping, ChannelLayout? forcedNumOutputChannels = null, int sampleRate = 0)
        {
            ...
            recDevice.InitRecordAndPlayback(null, (lastInputChannel - firstInputChannel) + 1, sampleRate);
            ...
            var format = new WaveFormat(sampleRate, 32, numOutputChannels);
